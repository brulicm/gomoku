...
public class Inteligenca extends splosno.KdoIgra {
	...
	/**
	 * Inteligentno izbere računalnikovo potezo glede na izbran algoritem.
	 * 
	 * @param igra
	 * 
	 * @return računalnikova poteza
	 */
	...
	public static OcenjenaPoteza alphaBeta(Igra igra, int globina, int alpha, int beta, Igralec jaz) {
		...
		// Nasprotnik začne z začetno oceno W, in jo nato minimizira.
		...
		for (Koordinati p : moznePoteze) {
			...
			if (alpha >= beta) // Gremo iz zanke, saj so ostale poteze slabše (tukaj se zgodi "optimizacija").
